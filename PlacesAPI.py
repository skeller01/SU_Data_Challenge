...
api_key = <API KEY> # Get your own Google Places Key 
...
df = pd.read_csv('Syracuse_Public_Art.csv') 
...
df['restaurant'] = df.apply(lambda x: get_nearest_restaurant(x['lat'], x['lng']), axis=1)
